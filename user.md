...
Create an account (local or online)
...
Change formatting (bold, italic, lists, etc.) via UI
...
Selective sync (choose which notes to keep local)

Storage usage summary (e.g., attachments size)
