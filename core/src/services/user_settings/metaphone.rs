...
pub static PHONETIC_CORPUS: phf::Map<&'static str, &'static [&'static str]> = phf_map! {
    ...
    "online.login" => &["login", "signin", "authenticate", "access", "session", "sign", "connect"],
    "online.logout" => &["logout", "signout", "exit", "leave", "sign", "disconnect"],
    "online.aiFeatures" => &["ai", "features", "editor", "generate", "notes", "intelligence", "automation", "smart"],
};
