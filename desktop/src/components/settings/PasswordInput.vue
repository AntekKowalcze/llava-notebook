    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div
            ...
            <div class="mb-4 flex items-center justify-between">
                <h3 class="text-lg font-semibold">Enter your password to generate codes</h3>
                <X @click="cancel" class="text-note-pumice cursor-pointer p-2 h-10 w-10" />
            </div>

            <TextInput :placeholder="'Password'" :type="InputTypes.Password" :name="'password'" v-model="password" />
