...
<!-- TODO readme with gifs etc -->
<!-- #LLava Notebook
Llava is 
**Privacy-focused cross-platform note-taking application with end-to-end encryption, offline-first local storage, cloud synchronization, secure authentication, and AI-assisted Markdown editing.** -->
